...
/**
 * The LocationPreferencePanel allows the user to select which dorms and areas
 * of campus they would be okay living in.
 * 
...
public class LocationPreferencePanel extends JPanel implements ChangeListener {
    ...
    public static LocationPreferencePanel getInstance() {
        return INSTANCE;
    }
    ...
    private LocationPreferencePanel() {
        ...
        ParentCheckBox masterBox = new ParentCheckBox(
        ...
        for (CampusArea area : Database.getCampusAreas()) {
            ...
            areaNamePanel.setLayout(new BoxLayout(areaNamePanel,
                    BoxLayout.X_AXIS));
    ...
    /**
     * Waits for people to click on one of the checkboxes, then updates the
     * currently selected house with a LocationPreference that has all the
     * currently selected dorms.
     * 
     */
        ...
        public void itemStateChanged(ItemEvent e) {
            if (!_changingState) {
                ...
                if (State.getInstance().getSelectedHouse() != null) {
                    State.getInstance().getSelectedHouse()
    ...
    public void stateChanged(ChangeEvent e) {
        ...
        if (State.getInstance().getSelectedHouse() != null) {
            for (Dorm dorm : State.getInstance().getSelectedHouse()
