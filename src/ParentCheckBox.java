...
/**
 * A ParentCheckBox is a JCheckBox with a special behavior:
 * when it is selected or unselected, all of its child checkboxes
 * are also selected/unselected.
 * 
 * To accomodate this behavior, the ParentCheckBox holds a reference
 * to all of its child checkboxes.
 * (Note that though there is a ChildCheckBox class, it exists for a different
 * (reciprocal) behavior; therefore, ParentCheckBox's child checkboxes need not be
 * ChildCheckBoxes.)
 * 
...
public class ParentCheckBox extends JCheckBox implements ItemListener {
	...
	/**
	 * When this checkbox is selected or unselected, 
	 * all of its child checkboxes are also selected/unselected.
	 */
	@Override
