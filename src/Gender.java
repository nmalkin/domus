...
public enum Gender {
	MALE  (Constants.MAN_FILE,   Constants.MAN_WIDTH,   Constants.MAN_HEIGHT), 
	FEMALE(Constants.WOMAN_FILE, Constants.WOMAN_WIDTH, Constants.WOMAN_HEIGHT);
	 ...
	 * @throws IOException if the image file could not be opened
	 */
