...
public class DatabaseConstants {
	...
	protected final static String[] SOPHOMORE_DORMS = {"111 Brown Street", "Diman House", "Grad Center D",
		"Harkness House", "Caswell Hall", "New Pembroke #1"};
	
	/** array of gender neutral dorms on campus */
	protected final static String[] NEUTRAL_DORMS = {"Caswell Hall", "Young Orchard #10", "Young Orchard #2", 
	...
	protected final static String[] APARTMENT_RATE_DORMS = {"Barbour Hall Apartments", "Gregorian Quad A", "Gregorian Quad B",
