...
public class ProbabilityDisplay extends JPanel {
    ...
    public ProbabilityDisplay(double probability) {
        ...
        Dimension dimension = new Dimension(
                Constants.PROBABILITY_DISPLAY_WIDTH,
                Constants.PROBABILITY_DISPLAY_HEIGHT);
    ...
    /**
     * Returns a string representation of the probability, as a value between 0
     * and 100, rounded to the nearest percentage, and with a % sign at the end.
     * 
    ...
    protected void paintComponent(Graphics g) {
        ...
        if (_probability != Constants.PROBABILITY_NO_DATA) { // only draw bar if
                                                             // this is a valid
                                                             // probability
                                                             // value
            ...
            g2.fill(new Rectangle(0, 0, Constants.PROBABILITY_DISPLAY_WIDTH,
                    Constants.PROBABILITY_DISPLAY_HEIGHT));
            ...
            // the above formula would've assigned it to a non-existent
            // (n+1-nth) category.
            // correct for this.
            if (category >= Constants.PROBABILITY_DISPLAY_COLORS.length) {
                category = Constants.PROBABILITY_DISPLAY_COLORS.length - 1; // assign
                                                                            // it
                                                                            // to
                                                                            // the
                                                                            // last
            ...
            // draw fill rectangle
            g2.setPaint(Constants.PROBABILITY_DISPLAY_COLORS[category]); // color
                                                                         // determined
                                                                         // by
                                                                         // category
            g2.fill(new Rectangle(0, 0, fillWidth,
                    Constants.PROBABILITY_DISPLAY_HEIGHT));
        }
    }
