package domus.gui.util;


import java.awt.Rectangle;

/**
 * Provides support code for drawing operations that's used by multiple
 * components and doesn't really fit anywhere else. (Essentially, this is a
 * mixin.)
 * 
 * @author nmalkin
 * 
