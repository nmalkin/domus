...
/**
 * A CampusArea is simply a collection of Dorms that can be found in that
 * particular area of campus.
 * 
 */
public class CampusArea extends AbstractCollection<Dorm> implements
        Comparable<CampusArea> {
