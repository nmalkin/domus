...
public class PreferencePanelItem extends JPanel implements AccordionItem {
    ...
    private ImageIcon _removeIcon = new ImageIcon(Constants.REMOVE_FILE,
            "remove from list");
    ...
    protected PreferencePanelItem(House house, Dorm dorm,
        ...
        this.add(Box
                .createRigidArea(new Dimension(Constants.OPEN_ICON_WIDTH, 0)));
        this.add(_label);
    ...
    private class HoverListener extends MouseAdapter {
        ...
        public void mouseEntered(MouseEvent e) {
            ...
            JLabel label = (JLabel) panel.getComponent(panel
                    .getComponentCount() - 2);
    ...
    private class RemoveListener extends MouseAdapter {
        ...
        public void mouseClicked(MouseEvent e) {
            ...
            JPanel itemsPanel = (JPanel) ((JComponent) e.getSource())
                    .getParent().getParent();
            itemsPanel.remove(panel);

            Dimension size = new Dimension(itemsPanel.getWidth(), itemsPanel
                    .getHeight()
            ...
            tab.setPreferredSize(new Dimension(tabSize.width, tabSize.height
                    - Constants.REMOVE_ICON_HEIGHT));
