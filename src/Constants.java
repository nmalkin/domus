...
=======
    ...
    protected static final Font DOMUS_FONT = FontLoader.load(PATH_PREFIX
            + "resources/GOTHIC.TTF");

    // General Graphics
    protected static final int INSET = 5; // pixels
    protected static final Border EMPTY_BORDER = new EmptyBorder(0, 0, 0, 0);
    protected static final String DOMUS_FILE = PATH_PREFIX
            + "img/domus_attempt_3.png";
    ...
    /**
     * what portion of an object is overlapping for the two to be considered
     * intersecting
     */
    protected static final double INTERSECTION_FRACTION = 0.5;
    ...
    // protected static final String TRASH_FILE = "img/trash.png";
    protected static final String TRASH_CLOSED_FILE = PATH_PREFIX
            + "img/trashcan_closed.png";
    protected static final String TRASH_OPEN_FILE = PATH_PREFIX
            + "img/trashcan_open.png";
    protected static final int TRASH_WIDTH = 77; // pixels
    protected static final int TRASH_HEIGHT = 140; // pixels
    protected static final float TRASH_OVERLAY_ALPHA_FRACTION = 0.25f;
    protected static final int TRASH_OVERLAY_ALPHA = (int) (TRASH_OVERLAY_ALPHA_FRACTION * 255);
    ...
    protected static final int HOUSE_PADDING = 25; // pixels
    protected static final Color HOUSE_COLOR_TRANSPARENT = new Color(
            HOUSE_COLOR.getRed(), HOUSE_COLOR.getGreen(),
            HOUSE_COLOR.getBlue(), TRASH_OVERLAY_ALPHA);

    protected static final int HOUSE_ROOF_HEIGHT = 40; // pixels

    protected static final Color SELECTED_HOUSE_BORDER_COLOR = new Color(49,
            49, 49);
    protected static final float SELECTED_HOUSE_BORDER_WIDTH = INSET + 0f;
    protected static final Color SELECTED_HOUSE_BORDER_COLOR_TRANSPARENT = new Color(
            SELECTED_HOUSE_BORDER_COLOR.getRed(), SELECTED_HOUSE_BORDER_COLOR
                    .getGreen(), SELECTED_HOUSE_BORDER_COLOR.getBlue(),
            TRASH_OVERLAY_ALPHA);
    ...
    protected static final int SUBGROUP_PADDING = 25; // pixels
    protected static final Color SUBGROUP_COLOR_TRANSPARENT = new Color(
            SUBGROUP_COLOR.getRed(), SUBGROUP_COLOR.getGreen(), SUBGROUP_COLOR
                    .getBlue(), TRASH_OVERLAY_ALPHA);
    ...
    // Results and lists icons
    protected static final String CLOSED_FILE = PATH_PREFIX
            + "img/closed_results_tab_new.png";
    protected static final String OPEN_FILE = PATH_PREFIX
            + "img/open_results_tab_new.png";
    protected static final String ADD_FILE = PATH_PREFIX
            + "img/add_to_list_center_1.png";
    protected static final String REMOVE_FILE = PATH_PREFIX
            + "img/remove_from_list_black_center_1.png";
    protected static final String LEFT_ARROW = PATH_PREFIX
            + "img/left_arrow_smaller.png";
    protected static final String RIGHT_ARROW = PATH_PREFIX
            + "img/right_arrow_smaller.png";
    protected static final int OPEN_ICON_WIDTH = 15;
    protected static final int REMOVE_ICON_HEIGHT = 16;
    ...
    protected static final int RESULTS_HEADER_HEIGHT = 30;
    protected static final int RESULTS_PANEL_WIDTH = 850;
    protected static final int RESULTS_PANEL_HEIGHT = RESULTS_LIST_HEIGHT
            + RESULTS_HEADER_HEIGHT;
    protected static final int RESULTS_LISTS_DISPLAYED = 2;
    protected static final int RESULTS_PANEL_HORIZONTAL_GAP = 5;

    // probability
    protected static final double PROBABILITY_NO_DATA = -1; // this must be < 0
                                                            // or > 1 to avoid
                                                            // accidental
                                                            // conflicts!
    ...
    /** How many different categories are we dividing probabilities into? */
    protected static final int PROBABILIY_DISPLAY_CATEGORIES = 5; // very
                                                                  // unlikely,
                                                                  // unlikely,
                                                                  // average,
                                                                  // likely,
                                                                  // very likely
    /**
     * The colors for each probability category, from least probability to
     * highest probability. (PROBABILITY_DISPLAY_COLORS.length must equal
     * PROBABILIY_DISPLAY_CATEGORIES)
     */
    protected static final Color[] PROBABILITY_DISPLAY_COLORS = {
            new Color(250, 100, 80), // red
            new Color(250, 200, 150), // orange
    ...
    // Database
    protected static final String DATABASE_NAME = PATH_PREFIX
            + "data/housingdata.db";
    protected static final String ROOM_TABLE = "rooms_with_regressions";
    protected static final String GENDER_TABLE = "genderNeutral";
    protected static final String SOPHOMORE_TABLE = "sophomoreOnly";
    ...
    protected static final String OKAY_FILE = PATH_PREFIX + "img/Undecided.png";
    protected static final String SAD_FILE = PATH_PREFIX + "img/Crying.png";
    protected static final String SAD_FILE_DIM = PATH_PREFIX
            + "img/Crying2.png";
    protected static final String OKAY_FILE_DIM = PATH_PREFIX
            + "img/Undecided2.png";
    protected static final String HAPPY_FILE_DIM = PATH_PREFIX
            + "img/Grin2.png";
    ...
    // HelpWindow
    protected static final String HELP_SCREEN_PREFERENCE_FILE = PATH_PREFIX
            + "help/preferences_screen_annotated.png";
    protected static final String HELP_SCREEN_RESULTS_FILE = PATH_PREFIX
            + "help/results_screen.png";
    protected static final String HELP_SCREEN_CART_FILE = PATH_PREFIX
            + "help/cart_screen.png";

    /** the height to which to scale the help screen images */
    protected static final int HELP_SCREEN_HEIGHT = 700;

>>>>>>> 5f17e3bcc73156ee05a0ef0c54cb320947686de8:src/Constants.java
}
