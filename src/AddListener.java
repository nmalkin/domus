...
public class AddListener extends MouseAdapter {
	...
	public void mouseClicked(MouseEvent e) {
		...
		_prompt = new JDialog(JOptionPane.getFrameForComponent((JComponent) e.getSource()), "Domus", true);
		...
		if (_container.getClass().getSimpleName().equals("ResultsListTab")) {
			_cb.addActionListener(((ResultsListTab) _container).new RoomListSelectionListener(_prompt));
		}
		else {
