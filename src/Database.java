...
public class Database {
	 ...
	 * @throws SQLException 
	 */
	public static RoomList getResults(Collection<Dorm> locations, int occupancy, int[] years, boolean genderNeutral, boolean sophomoreEligible) throws SQLException {
